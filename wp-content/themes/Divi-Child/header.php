    ...
    <header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
        <div class="container clearfix et_menu_container">
            ...
            <div id="et-top-navigation" data-height="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>" data-fixed-height="<?php echo esc_attr( et_get_option( 'minimized_menu_height', '40' ) ); ?>">
                <?php if ( ! $et_slide_header || is_customize_preview() ) : ?>
                    <nav id="top-menu-nav center-menu">
                        <?php
                        $menuClass = 'nav';
                    ...
                    <nav id="top-menu-nav right-menu">
                        <?php
                        $menuClass = 'nav';
                        if ( 'on' === et_get_option( 'divi_disable_toptier' ) ) $menuClass .= ' et_disable_top_tier';
                        $contactUsNav = '';
                        $contactUsNav = wp_nav_menu( array( 'theme_location' => 'contact_us_menu', 'container' => '', 'fallback_cb' => '', 'menu_class' => $menuClass, 'menu_id' => 'right-menu', 'echo' => false ));
                        if(!empty($contactUsNav)) {
                            echo et_core_esc_wp($contactUsNav);
                        } else {
                            echo 'Assign a Contact Us button!';
                        }
                        ?>
                    </nav>
                <?php endif; ?>
