...
/**
 * Custom Resources Module, developed for ANCR by ICCW 2019.
 * Due to partial builder support, all advanced options (except button options) are added by default
 *
 * @since 1.0.0
 */
class CustomResourcesModule extends ET_Builder_Module_Type_PostBased
{
    function init()
    {
        $this->name = esc_html__('ANCR Custom Resources Element', 'et_builder');
        $this->plural = esc_html__('ANCR Custom Resources', 'et_builder');
        $this->slug = 'ancr_divi_resources';
        $this->vb_support = 'partial';

        // need to use global settings from the slider module
        $this->global_settings_slug = 'ancr_custom_resources';

        $this->main_css_element = '%%order_class%%.ancr_custom_resources';
        ...
        $this->advanced_fields = array(
            'fonts' => array(
                'header' => array(
                    ...
                    'css' => array(
                        'main' => "{$this->main_css_element} .ancr_custom_resources_description .ancr_custom_resources_title, {$this->main_css_element} .ancr_custom_resources_description .ancr_custom_resources_title a",
                ...
                'body' => array(
                    ...
                    'css' => array(
                        'line_height' => "{$this->main_css_element}, {$this->main_css_element} .ancr_custom_resources_content",
                        'main' => "{$this->main_css_element} .ancr_custom_resources_content, {$this->main_css_element} .ancr_custom_resources_content div",
                        'important' => 'all',
                    ),
                    'block_elements' => array(
                        ...
                        'css' => array(
                            'link' => "{$this->main_css_element} .ancr_custom_resources_content a",
                            'ul' => "{$this->main_css_element} .ancr_custom_resources_content ul",
                            'ol' => "{$this->main_css_element} .ancr_custom_resources_content ol",
                            'quote' => "{$this->main_css_element} .ancr_custom_resources_content blockquote",
                        ),
                    ),
                ),
                'meta' => array(
                    ...
                    'css' => array(
                        'main' => "{$this->main_css_element} .ancr_custom_resources_content .post-meta, {$this->main_css_element} .ancr_custom_resources_content .post-meta a",
                        'limited_main' => "{$this->main_css_element} .ancr_custom_resources_content .post-meta, {$this->main_css_element} .ancr_custom_resources_content .post-meta a, {$this->main_css_element} .ancr_custom_resources_content .post-meta span",
                        'important' => 'all',
                    ),
                    'line_height' => array(
                        'default' => '1em',
            ...
            'box_shadow' => array(
                ...
                'image' => array(
                    ...
                    'toggle_slug' => 'image',
                    'css' => array(
                        'main' => '%%order_class%% .ancr_custom_resources_image img',
                    ),
            ...
            'borders' => array(
                'default' => array(
                    'css' => array(
                        'main' => array(
                            'border_radii' => '%%order_class%%, %%order_class%% .ancr_custom_resources, %%order_class%% .ancr_custom_resources_overlay_container',
                        ),
                    ),
                ),
                'image' => array(
                    'css' => array(
                        'main' => array(
                            'border_radii' => '%%order_class%% .ancr_custom_resources .ancr_custom_resources_image img',
                            'border_styles' => '%%order_class%% .ancr_custom_resources .ancr_custom_resources_image img',
                        )
                    ),
            ...
            'margin_padding' => array(
                'css' => array(
                    'main' => '%%order_class%%',
                    'padding' => '%%order_class%% .ancr_custom_resources_description, .ancr_custom_resources_fullwidth_off%%order_class%% .ancr_custom_resources_description',
            ...
            'text' => array(
                ...
                'css' => array(
                    'main' => implode(', ', array(
                        '%%order_class%% .ancr_custom_resources .ancr_custom_resources_description .ancr_custom_resources_title',
                        '%%order_class%% .ancr_custom_resources .ancr_custom_resources_description .ancr_custom_resources_title a',
                        '%%order_class%% .ancr_custom_resources .ancr_custom_resources_description .ancr_custom_resources_content',
                        '%%order_class%% .ancr_custom_resources .ancr_custom_resources_description .ancr_custom_resources_content .post-meta',
                        '%%order_class%% .ancr_custom_resources .ancr_custom_resources_description .ancr_custom_resources_content .post-meta a'
                    )),
                    'text_orientation' => '%%order_class%% .ancr_custom_resources .ancr_custom_resources_description',
                    'text_shadow' => '%%order_class%% .ancr_custom_resources .ancr_custom_resources_description',
                ),
                'options' => array(
            ...
            'image' => array(
                'css' => array(
                    'main' => '%%order_class%% .ancr_custom_resources_image',
                ),
            ),
            'height' => array(
                'css' => array(
                    'main' => '%%order_class%%, %%order_class%% .ancr_custom_resources',
                )
            ),
            'max_width' => array(
                'extra' => array(
                    'content' => array(
                        ...
                        'css' => array(
                            'main' => '%%order_class%% .ancr_custom_resources > .et_pb_container',
                        ),
                        'options' => array(
                            'width' => array(
    ...
    function get_fields()
    {
        $fields = array(
            ...
            '__posts' => array(
                'type' => 'computed',
                'computed_callback' => array('ET_Builder_Module_ancr_custom_resources', 'get_blog_posts'),
    ...
    public function get_transition_fields_css_props()
    {
        ...
        $fields['background_layout'] = array(
            'background-color' => '%%order_class%% .ancr_custom_resources_overlay_container, %%order_class%% .et_pb_text_overlay_wrapper',
            'color' => self::$_->array_get($this->advanced_fields, 'text.css.main', '%%order_class%%'),
        );

        $fields['bg_overlay_color'] = array(
            'background-color' => '%%order_class%% .ancr_custom_resources .ancr_custom_resources_overlay_container',
        );

        $fields['text_overlay_color'] = array(
            'background-color' => '%%order_class%% .ancr_custom_resources .et_pb_text_overlay_wrapper',
        );
    ...
    function render($attrs, $content = null, $render_slug)
    {
        ...
        if ('on' === $this->props['show_image'] && 'background' === $this->props['image_placement'] && 'off' === $parallax) {
            if ('' !== $background_color) {
                ET_Builder_Module::set_style($render_slug, array(
                    'selector' => '%%order_class%% .ancr_custom_resources:not(.ancr_custom_resources_with_no_image)',
                    'declaration' => sprintf(
            ...
            if ('' !== $background_size && 'default' !== $background_size) {
                ET_Builder_Module::set_style($render_slug, array(
                    'selector' => '%%order_class%% .ancr_custom_resources',
                    'declaration' => sprintf(
                ...
                if ('initial' === $background_size) {
                    ET_Builder_Module::set_style($render_slug, array(
                        'selector' => 'body.ie %%order_class%% .ancr_custom_resources',
        ...
        if ('on' === $use_bg_overlay) {
            ...
            et_pb_responsive_options()->generate_responsive_css($bg_overlay_color_values, '%%order_class%% .ancr_custom_resources .ancr_custom_resources_overlay_container', 'background-color', $render_slug, '', 'color');

            if ('' !== $bg_overlay_color_hover) {
                ET_Builder_Element::set_style($render_slug, array(
                    'selector' => $this->add_hover_to_order_class('%%order_class%% .ancr_custom_resources .ancr_custom_resources_overlay_container'),
                    'declaration' => sprintf(
                        'background-color: %1$s;',
        ...
        if ($is_text_overlay_applied) {
            // Text Overlay color.
            et_pb_responsive_options()->generate_responsive_css($text_overlay_color_values, '%%order_class%% .ancr_custom_resources .et_pb_text_overlay_wrapper', 'background-color', $render_slug, '', 'color');

            if ('' !== $text_overlay_color_hover) {
                ET_Builder_Element::set_style($render_slug, array(
                    'selector' => $this->add_hover_to_order_class('%%order_class%% .ancr_custom_resources .et_pb_text_overlay_wrapper'),
                    'declaration' => sprintf(
                        'background-color: %1$s;',
        ...
        et_pb_responsive_options()->generate_responsive_css($text_border_radius_values, '%%order_class%%.ancr_custom_resources_with_text_overlay .et_pb_text_overlay_wrapper', 'border-radius', $render_slug);
        ...
        if ($query->have_posts()) {
            while ($query->have_posts()) {
                ...
                $multi_view_attrs_wrapper = $multi_view->render_attrs(array(
                    ...
                    'classes' => array(
                        'ancr_custom_resources_with_image' => array(
                            'show_image' => 'on',
                            'has_post_thumbnail' => '__return_true',
                            'image_placement' => array('left', 'right'),
                        ),
                        'ancr_custom_resources_with_no_image' => array(
                            'show_image' => 'on',
                ...
                $slide_class = 'off' !== $show_image && in_array($image_placement, array('left', 'right')) && $has_post_thumbnail ? ' ancr_custom_resources_with_image' : '';
                $slide_class .= 'off' !== $show_image && !$has_post_thumbnail ? ' ancr_custom_resources_with_no_image' : '';
                ...
                ?>
                <div class="ancr_custom_resources et_pb_media_alignment_center<?php echo esc_attr($slide_class); ?>">
                    <div class="column ancr_custom_resources_image mobile_on" <?php echo et_core_esc_previously($multi_view_attrs_show_image); ?>>
                        <?php the_post_thumbnail($size ="medium_large"); ?>
                    </div>
                    <div class="row et_pb_container clearfix">
                        <?php if ($is_show_image && $has_post_thumbnail && 'left' === $image_placement) { ?>
                            <div class="column ancr_custom_resources_image mobile_off" style="background-image:url('<?php the_post_thumbnail_url() ?>')" <?php echo et_core_esc_previously($multi_view_attrs_show_image); ?>>
                            </div>
                        <?php } ?>
                        <div class="column ancr_custom_resources_container_inner">

                            <div class="ancr_custom_resources_description">
                                ...
                                <div class="et_pb_text_overlay_wrapper"><?php endif; ?>
                                    ...
                                    class="ancr_custom_resources_title"><a
                                            href="<?php esc_url(the_permalink()); ?>"><?php the_title(); ?></a>
                                </<?php echo et_pb_process_header_level($header_level, 'h2') ?>>
                                <div class="ancr_custom_resources_content <?php if ('on' !== $show_content_on_mobile) {
                            ...
                            <div class="column">
                                <div class="resource_date"> <?= get_the_date() ?></div>
                            </div>
                            </div>
                        </div><!-- .ancr_custom_resources_description -->
                    </div>
                    <?php if ($is_show_image && $has_post_thumbnail && 'right' === $image_placement) { ?>
                        <div class="column ancr_custom_resources_image mobile_off" style="background-image:url('<?php the_post_thumbnail_url($size ="medium_large") ?>')" <?php echo et_core_esc_previously($multi_view_attrs_show_image); ?>>
                        </div>
                    <?php } ?>
                </div> <!-- .et_pb_container -->
                </div> <!-- .ancr_custom_resources -->
                <?php
                $post_index++;
                ET_Post_Stack::pop();
            } // end while
        ...
        $this->add_classname(array(
            'ancr_custom_resources',
            "et_pb_ancr_custom_resources_image_{$image_placement}",
        ));

        $this->add_classname('ancr_custom_resources_fullwidth_off');

        if ('off' === $show_arrows) {
            $this->add_classname('ancr_custom_resources_no_arrows');
        }

        if ('off' === $show_pagination) {
            $this->add_classname('ancr_custom_resources_no_pagination');
        }

        if ('on' === $parallax) {
            $this->add_classname('ancr_custom_resources_parallax');
        }
        ...
        if ('on' === $show_image_video_mobile) {
            $this->add_classname('ancr_custom_resources_show_image');
        }

        if ('on' === $use_bg_overlay) {
            $this->add_classname('ancr_custom_resources_with_overlay');
        }

        if ('on' === $use_text_overlay) {
            $this->add_classname('ancr_custom_resources_with_text_overlay');
        }
        ...
        $muti_view_data_attr = $multi_view->render_attrs(array(
            'classes' => array(
                'ancr_custom_resources_no_arrows' => array(
                    'show_arrows' => 'off',
                ),
                'ancr_custom_resources_no_pagination' => array(
                    'show_pagination' => 'off',
                ),
                'et_pb_ancr_custom_resources_image_background' => array(
                    'image_placement' => 'background',
                ),
                'et_pb_ancr_custom_resources_image_left' => array(
                    'image_placement' => 'left',
                ),
                'et_pb_ancr_custom_resources_image_right' => array(
                    'image_placement' => 'right',
                ),
                'et_pb_ancr_custom_resources_image_top' => array(
                    'image_placement' => 'top',
                ),
                'et_pb_ancr_custom_resources_image_bottom' => array(
        ...
        $output = sprintf(
            '<div%3$s class="%1$s"%7$s%8$s%9$s>
				%5$s
				%4$s
				<div class="ancr-main-resources-container">
				<div class="upper-left"></div>
				<div class="ancr_custom_resources">
					%2$s
				</div> <!-- .ancr_custom_resources -->
    ...
    private function inner_shadow_back_compatibility($functions_name)
    {
        ...
        version_compare($utils->array_get($atts, '_builder_version', '3.0.93'), '3.0.99', 'lt')
            ...
            $style = sprintf(
                '<style>%1$s</style>',
                sprintf(
                    '.%1$s.ancr_custom_resources .ancr_custom_resources {'
