...
class Jwt_Auth_Public
{
    ...
    public function generate_token($request)
    {
        ...
        /** ICC Custom Code Starts */
        //remove avectra user validation as this will be wordpress local user.
        global $wp_av_sso;
        if(null !== $wp_av_sso){
            remove_filter('authenticate', array($wp_av_sso, 'authenticate'), 30);
        }
        /** ICC Custom code Ends */
        ...
        /** ICC Custom Code Starts */
        /** ICC Custom code to check user permissions. */
        if (false === user_can($user, 'allow_rest_api_access')) {
